...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-gray-600">Welcome back! Here's what's happening with your social media accounts.</p>
    </div>
        ...
        <div class="card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">24,561</p>
                </div>
            </div>
        </div>
        ...
        <div class="card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">12,890</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900">Twitter Post</p>
                            <p class="text-sm text-gray-600">New product launch announcement</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900">Instagram Post</p>
                            <p class="text-sm text-gray-600">Behind the scenes content</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900">LinkedIn Article</p>
                            <p class="text-sm text-gray-600">Industry insights and trends</p>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <button class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <span class="text-sm font-medium text-gray-900">Create Post</span>
                    </button>

                    <button class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mb-2">
                            <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4h4a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V9a2 2 0 012-2h2z"></path>
                            </svg>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-gray-600">@yourcompany</p>
                    </div>
                    <div class="ml-auto">
                ...
                <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-gray-600">Your Company</p>
                    </div>
                    <div class="ml-auto">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">Disconnected</span>
                    </div>
                </div>
            </div>
        </div>
