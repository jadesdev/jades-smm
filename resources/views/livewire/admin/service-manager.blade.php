...
<div>
    <x-card>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <x-forms.input wire:model.live.debounce.300ms="search" placeholder="Search services..." />
                    ...
                    @forelse ($services as $service)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                <x-button wire:click="edit({{ $service->id }})" variant="primary"
                                    size="xs">Edit</x-button>
                                <x-button wire:click="delete({{ $service->id }})" variant="danger"
                                    size="xs">Delete</x-button>
                            </td>
                        </tr>
                    @empty
                        <tr>
    ...
    <x-modal name="delete-service-modal" title="Confirm Deletion" persistent="true">
        <p class="text-gray-600 dark:text-gray-300">Are you sure you want to delete this service? This action cannot be
            undone.</p>
        <x-slot name="footer">
