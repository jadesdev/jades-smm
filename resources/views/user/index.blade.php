...
@section('content')
    <!-- Welcome Section -->
    <div class="mb-8">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 text-white dark:bg-gradient-to-r dark:from-indigo-800 dark:to-purple-800">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">Welcome back, John!</h2>
                    <p class="text-indigo-100 dark:text-indigo-300">Here's what's happening with your SMM campaigns
                        today.</p>
                </div>
                <div class="hidden md:block">
                    <i class="fas fa-chart-line text-4xl text-indigo-200 dark:text-indigo-500"></i>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-indigo-100 dark:bg-indigo-800 p-3 rounded-full">
                    <i class="fas fa-shopping-cart text-indigo-600 dark:text-indigo-100"></i>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-green-100 dark:bg-green-800 p-3 rounded-full">
                    <i class="fas fa-cogs text-green-600 dark:text-green-100"></i>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-yellow-100 dark:bg-yellow-800 p-3 rounded-full">
                    <i class="fas fa-dollar-sign text-yellow-600 dark:text-yellow-100"></i>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-purple-100 dark:bg-purple-800 p-3 rounded-full">
                    <i class="fas fa-chart-line text-purple-600 dark:text-purple-100"></i>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-4">
                    <div class="bg-green-100 dark:bg-green-800 p-2 rounded-full">
                        <i class="fas fa-check text-green-600 dark:text-green-100"></i>
                    </div>
                    <div class="flex-1">
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-100 dark:bg-blue-800 p-2 rounded-full">
                        <i class="fas fa-clock text-blue-600 dark:text-blue-100"></i>
                    </div>
                    <div class="flex-1">
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-yellow-100 dark:bg-yellow-800 p-2 rounded-full">
                        <i class="fas fa-exclamation-triangle text-yellow-600 dark:text-yellow-100"></i>
                    </div>
                    <div class="flex-1">
