...
<div
    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-lg border border-gray-200 dark:border-gray-700 mb-4"
    ...
    <div 
        class="border-t border-gray-100 dark:border-gray-600 p-6"
        x-show="expanded"
